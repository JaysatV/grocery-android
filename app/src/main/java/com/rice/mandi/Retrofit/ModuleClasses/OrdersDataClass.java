...
public class OrdersDataClass {
    String customer_id, customer_name, customer_phone, delivery_address, payment_method, payment_ref, updated_at, created_at, lati, longi, token;
    Float items_total, delivery_charges, total_amount;
    int payment_status, order_status, id;
